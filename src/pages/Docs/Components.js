              ...
              <Col lg={3} md={4} xs={12} className="d-none d-md-block">
                <div className="sticky-bar component-wrapper bg-light rounded shadow p-4">
                  ...
                  <ul className="list-unstyled mb-0">
                    <li>
                      <a href="#typography" className="mouse-down h6 text-dark">
                        Typography Heading
                      </a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a href="#bg-colors" className="mouse-down h6 text-dark">
                        Background Colors
                      </a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a href="#dropdowns" className="mouse-down h6 text-dark">
                        Dropdowns
                      </a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a href="#accordions" className="mouse-down h6 text-dark">
                        Accordions
                      </a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a href="#checkboxes" className="mouse-down h6 text-dark">
                        Checkboxes
                      </a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a href="#select-box" className="mouse-down h6 text-dark">
                        Form Select Box
                      </a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a href="#pagination" className="mouse-down h6 text-dark">
                        Pagination
                      </a>
                    </li>
                    <li>
